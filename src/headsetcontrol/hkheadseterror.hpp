...
[[maybe_unused]] QDebug operator<<(QDebug debug, const HKHeadsetError &error);

namespace HKUtils
{
[[nodiscard]] QString headsetErrorLocaleErrorString(const HKHeadsetError &error);
[[nodiscard]] QString headsetErrorToLocaleString(HKHeadsetError::Error error);
} // namespace HKUtils
