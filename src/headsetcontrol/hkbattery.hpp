...
namespace HKUtils
{
[[nodiscard]] QString batteryIconName(const HKBattery &battery, bool styled = false, const QString &fallback = {});
[[nodiscard]] QString batteryStatusToLocaleString(HKBattery::BatteryStatus status);
} // namespace HKUtils
