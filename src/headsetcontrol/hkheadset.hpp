...
class HKHeadset : public QObject
{
    Q_OBJECT
...
namespace HKUtils
{
[[nodiscard]] QString capabilityToLocaleString(HKHeadset::Capability capability);
[[nodiscard]] QStringList capabilitiesToLocaleStrings(HKHeadset::Capabilities capabilities);
} // namespace HKUtils
