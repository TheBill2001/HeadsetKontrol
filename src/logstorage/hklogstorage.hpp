...
[[nodiscard]] inline std::weak_ordering operator<=>(const HKLogEntry &lhs, const HKLogEntry &rhs)
{
    return lhs.m_timestamp <=> rhs.m_timestamp;
};

[[nodiscard]] inline bool operator==(const HKLogEntry &lhs, const HKLogEntry &rhs)
{
...
[[maybe_unused]] QDataStream &operator<<(QDataStream &stream, const HKLogEntry &entry);
[[maybe_unused]] QDataStream &operator>>(QDataStream &stream, HKLogEntry &entry);

class HKLogStorage : public QObject
{
    Q_OBJECT
