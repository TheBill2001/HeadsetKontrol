...
import org.kde.headsetkontrol
import org.kde.headsetkontrol.settings as Settings
...
StatefulApp.StatefulWindow {
    ...
    title: i18nc("@title:window", "HeadsetKontrol")

    windowName: "HeadsetKontrol"

    minimumWidth: Kirigami.Units.gridUnit * 20
    minimumHeight: Kirigami.Units.gridUnit * 20

    application: HeadsetKontrolApplication {
        configurationView: Settings.HeadsetKontrolConfigurationView {}
    }
    ...
    pageStack.initialPage: FormCard.FormCardPage {
        ...
        title: i18nc("@title", "HeadsetKontrol")
        ...
        Kirigami.Heading {
            text: i18nc("@title", "Welcome to HeadsetKontrol") + '\n' + i18nc("@info:status", "Counter: %1", root.counter)
