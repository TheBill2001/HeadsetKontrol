...
# Taken from: https://github.com/Zren/plasma-applet-lib/blob/master/package/translate/merge
...
cp -f "$DIR/../headsetkontrol.desktop" "$DIR/template.desktop"
...
# Cleanup
mv "$DIR/new.desktop" "$DIR/../headsetkontrol.desktop"
