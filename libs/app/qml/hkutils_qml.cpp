...
#include "hkutils_qml.hpp"

#include <KLocalizedString>

using namespace Qt::StringLiterals;

qint32 HKUtilsQml::localeStringToMilliseconds(const QString &text, const QLocale &locale)
{
    const auto _text =
...
QString HKUtilsQml::millisecondsToLocaleString(int value)
{
