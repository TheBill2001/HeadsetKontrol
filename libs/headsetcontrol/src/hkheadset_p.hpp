...
#include "hkcommonmacros.hpp"
#include "hkcommonutils.hpp"
#include "hkhc_logging_p.hpp"
...
class HKHC_NO_EXPORT HKHeadset::InitData
{
public:
...
class HKHC_NO_EXPORT HKHeadsetPrivate : public HKObjectPrivate<HKHeadset>
{
