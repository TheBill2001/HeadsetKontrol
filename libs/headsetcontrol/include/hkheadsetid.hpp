...
[[nodiscard]] HKHC_EXPORT std::partial_ordering operator<=>(const HKHeadsetId &lhs, QAnyStringView rhs) noexcept;
[[nodiscard]] HKHC_EXPORT bool operator==(const HKHeadsetId &lhs, QAnyStringView rhs) noexcept;

[[maybe_unused]] HKHC_EXPORT QDebug operator<<(QDebug debug, const HKHeadsetId &HKHeadsetId);
