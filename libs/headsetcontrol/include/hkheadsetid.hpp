...
constexpr std::strong_ordering operator<=>(const HKHeadsetId &lhs, const HKHeadsetId &rhs) noexcept
{
...
constexpr bool operator==(const HKHeadsetId &lhs, const HKHeadsetId &rhs) noexcept
{
    return lhs.vendorId == rhs.vendorId && lhs.productId == rhs.productId;
}

constexpr std::strong_ordering operator<=>(const HKHeadsetId &lhs, const std::pair<quint16, quint16> &rhs) noexcept
{
...
constexpr bool operator==(const HKHeadsetId &lhs, const std::pair<quint16, quint16> &rhs) noexcept
{
